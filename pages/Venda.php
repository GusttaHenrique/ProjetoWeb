...
foreach ($lista as $servico) {
    ...
    echo "<td><button class='btn btn-success btn-circle' onclick='adicionarNoCarrinho(\"".$servico->getCodigo()."\",\"".$servico->getNome()."\",".$servico->getPreco().")'><i class=' fa fa-shopping-basket'></i></button></td>";
    echo "</tr>";
}
?>
