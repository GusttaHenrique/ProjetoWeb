<!-- Navigation -->
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">SysOficin</a>
                </div>
                ...
                <ul class="nav navbar-nav navbar-left navbar-top-links">
                    <li><a href="#"><i class="fa fa-home fa-fw"></i> Bem Vindo</a></li>
                </ul>
                <ul class="nav navbar-nav navbar-left navbar-top-links">
                    <li><a href="#"><i class="fa fa-facebook-f fa-fw"></i></a></li>
                </ul>
                <ul class="nav navbar-nav navbar-left navbar-top-links">
                        ...
                        <ul class="dropdown-menu dropdown-alerts">
                            ...
                            <li>
                                <a class="text-center" href="#">
                                    <strong>Exibir Todas as Notificações</strong>
                                    <i class="fa fa-angle-right"></i>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <!-- Usuario ao lado do sininho -->
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
